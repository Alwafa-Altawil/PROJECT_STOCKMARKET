      ...
      <nav className={`sticky top-0 z-10 transition-colors duration-300 ${
        ...
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3 py-3 px-4">
            <button
              onClick={toggleTheme}
              className={`py-2 px-3 text-sm font-bold uppercase tracking-widest rounded transition-all ${
                isDarkMode
            ...
            <span className={`text-lg font-black hidden sm:inline ${
              isDarkMode ? "text-white" : "text-black"
            }`}>
              Trade<span className="text-blue-600">Xpert</span>
            </span>
          </div>
        ...
        {activeTab === "watchlist" && (
          <div className="space-y-6 animate-in fade-in duration-500">
            <div className={`p-8 rounded-3xl shadow-sm border transition-colors duration-300 ${
              ...
              <h2 className={`text-xs font-black uppercase mb-8 tracking-widest transition-colors duration-300 ${
                isDarkMode ? "text-zinc-400" : "text-zinc-400"
              }`}>
                My Watchlist
              </h2>
                ...
                <table className="w-full">
                  <thead>
                    <tr className={`border-b transition-colors duration-300 ${
                      ...
                      <th className={`text-left py-4 px-6 text-xs font-semibold uppercase tracking-wider transition-colors duration-300 ${
                      ...
                      <th className={`text-right py-4 px-6 text-xs font-semibold uppercase tracking-wider transition-colors duration-300 ${
                        isDarkMode ? "text-zinc-300" : "text-zinc-600"
                      }`}>
                        Last 24 hours
                      </th>
                  ...
                  <tbody>
                    {market.stocks.map((stock) => {
                      ...
                      return (
                        ...
                        >
                          <td className={`py-5 px-6 font-bold transition-colors duration-300 ${
                            isDarkMode ? "text-white" : "text-zinc-900"
                          }`}>{stock.symbol}</td>
        ...
        {activeTab === "analyse" && (
          <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className={`p-8 rounded-3xl shadow-sm border transition-colors duration-300 ${
              ...
              <h2 className={`text-xs font-black uppercase mb-6 tracking-widest transition-colors duration-300 ${
                isDarkMode ? "text-zinc-400" : "text-zinc-400"
              }`}>
                  ...
                  {market.forecasts.map((forecast: Forecast) => (
                    ...
                    >
                      ...
                      <div className="space-y-3 mb-4">
                        ...
                        <div className={`pt-2 border-t text-xs transition-colors duration-300 ${
                          isDarkMode
